...
def demographic_whole_genome(roh_file, prefix):
    ...
    roh_categories = {
        "0.5-1.0 Mb": (0, 1000),
        "1.0-2.0 Mb": (1000, 2000),
        "2.0-4.0 Mb": (2000, 4000),
        "4.0-8.0 Mb": (4000, 8000),
        "8.0-16.0 Mb": (8000, 16000),
        ">16.0 Mb": (16000, float("inf"))
    }
    genome_size = 2466191 # autosome size in KB - Constant for Froh calculation
    ...
    for line in roh_file:
        ...
        sample, roh_size = line_parts[0], float(line_parts[8])
